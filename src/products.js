...
function Products() {
    ...
    function handleExpiredCheckboxChange(e) {
        ...
        const updatedFilteredProducts = isChecked ? 
            products.filter(item => new Date(item.expiryDate).getTime() < new Date().getTime()) :
            products;
     ...
     <div class="navbar">
        <div class="Navbar_Menu">
            ...
            <nav>
                ...
                <a class="nav-items active" href="./products">Products</a>
    ...
    <div class="order_page">
        <h1 class="order_header">Products</h1>
        <div class="table_container">
            <div class="filter-container">
                ...
                <div class="filter-option">
                    ...
                    <input type="checkbox" name="orders-new" id="expiredCheckBox" onChange={handleExpiredCheckboxChange} />Expired </label>  
                       
                    <label class="filter-checkbox">
                    <input type="checkbox" name="orders-packed" id="lowStockCheckBox"  onChange={handleLowStockCheckboxChange} />Low Stock
